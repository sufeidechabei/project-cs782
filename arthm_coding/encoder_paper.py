...
class PaperArthmEncoder:
    ...
    def adjust(self, token, model_name = None):
        ...
        self.a = self.b + math.floor(cumu * diff)
    ...
    def encode(self, token_list, model_name = None):
        ...
        for token in token_list:
            ...
            dbf_a = util.double_floor_op(self.a, self.r*self.l, self.r*self.l-1)
            dbf_b = util.double_floor_op(self.b - 1, self.r*self.l, self.r*self.l-1)
